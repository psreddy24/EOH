...
describe('Service Tests', () => {
  describe('Employee Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Employee(0, 'AAAAAAA', currentDate, currentDate);
    });
    ...
    describe('Service methods', () => {
      it('should find an element', () => {
        const returnedFromService = Object.assign(
          {
            employedDate: currentDate.format(DATE_TIME_FORMAT),
            terminatedDate: currentDate.format(DATE_TIME_FORMAT),
          },
          elemDefault
        );
